 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),stringify=_dereq_("json3").stringify;module.exports=function quote(string){return stringify(safeToString(string))}},{json3:4,"safe-to-string-x":5}],2:[function(_dereq_,module,exports){/**
