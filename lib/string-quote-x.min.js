 ...
 */
"use strict";var safeToString=_dereq_("to-string-symbols-supported-x"),stringify=_dereq_("json3").stringify;module.exports=function quote(string){return stringify(safeToString(string))}},{json3:5,"to-string-symbols-supported-x":6}],2:[function(_dereq_,module,exports){/**
