 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),JSON3=_dereq_("json3");module.exports=function _quote(string){return JSON3.stringify(safeToString(string))}},{json3:4,"safe-to-string-x":5}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":2,"is-symbol":3}]},{},[1])(1)});